...
## Description
This app is a simple goals list app made for iOS and Android. It is a simple app that allows the user to add, edit, and delete goals.

## React Native Dependencies Used
 - StyleSheet
 - View
 - Test
 - TextInput
